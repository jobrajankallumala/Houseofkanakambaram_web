...
export default class UpdateAddressForm extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
    ...
    componentDidMount() {
        ...
        this.setState({
            address_id: this.props.editItem.id,
            address_line_one: this.props.editItem.address_line_one,
            address_line_two: this.props.editItem.address_line_two,
            city: this.props.editItem.city,
            postal_code: this.props.editItem.postal_code,
            country_id: this.props.editItem.country_id,
            contact_name: this.props.editItem.contact_name,
            contact_phone: this.props.editItem.contact_phone,
            contact_email: this.props.editItem.contact_email,
        })
    }
        ...
        HttpService.post(url, data)
            .then(response => {
                ...
                if (response.status == 422) {
                    ...
                    this.props.done(response.data.data)
                }
            })
            .catch(error => {
                this.setState({ loading: false })
            ...
            <div className="tm-form address-form">
                <Form onSubmit={this.handleSubmit}>
                    <Row className="row">
                        ...
                        <Form.Group controlId="formBasicEmail" className="col-sm-12" >
                            <Button className="submit" type="submit">Update address</Button>
                        </Form.Group>
